...
import '../controllers/TransacaoCubit.dart';
import '../controllers/TransacaoState.dart';
...
class _NovaTransacaoPageState extends State<NovaTransacaoPage> {
  ...
  final List<String> _categorias = ['Alimentação', 'Transporte', 'Lazer', 'Casa', 'Saúde'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Novo Registro", style: TextStyle(color: Color(0xFF1E293B))),
      ),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildTipoBotao("Gastei", TipoTransacao.SAIDA, const Color(0xFFE2A499)),
                    const SizedBox(width: 16),
                    _buildTipoBotao("Recebi", TipoTransacao.ENTRADA, const Color(0xFFB2AC88)),
                  ],
                ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    prefixText: "R\$ ",
                    prefixStyle: const TextStyle(fontSize: 40, color: Color(0xFF94A3B8)),
                ...
                // Categoria (Chips)
                const Text("Categoria", style: TextStyle(fontWeight: FontWeight.w600, color: Color(0xFF475569))),
                ...
                Wrap(
                  ...
                  children: _categorias.map((cat) {
                    return ChoiceChip(
                      ...
                      onSelected: (selected) {
                        if (selected) setState(() => _categoriaSelecionada = cat);
                      },
                    );
                  }).toList(),
                ),
                ...
                if (_tipoSelecionado == TipoTransacao.SAIDA) ...[
                  const Text("Como você estava se sentindo?", style: TextStyle(fontWeight: FontWeight.w600, color: Color(0xFF475569))),
                  const SizedBox(height: 12),
                  Wrap(
                    spacing: 8,
                    children: EstadoEmocional.values.map((emocao) {
                      return ChoiceChip(
                        ...
                        backgroundColor: Colors.white,
                        onSelected: (selected) {
                          setState(() => _emocaoSelecionada = selected ? emocao : null);
                        },
                      );
                    }).toList(),
                  ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                        ...
                        : () {
                            ...
                            if (valor > 0) {
                              context.read<TransacaoCubit>().registrarTransacao(
                                ...
                                estadoEmocional: _tipoSelecionado == TipoTransacao.SAIDA ? _emocaoSelecionada : null,
                              );
                            }
                          },
                    ...
                    child: state is TransacaoLoading
                        ...
                        : const Text("Salvar Registro", style: TextStyle(fontSize: 18, color: Colors.white)),
                  ),
                ),
              ],
            ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isSelected ? corAtiva : const Color(0xFFE2E8F0)),
        ),
        child: Text(
          texto,
          style: TextStyle(
